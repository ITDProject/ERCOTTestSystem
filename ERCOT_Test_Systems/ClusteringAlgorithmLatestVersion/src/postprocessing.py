...
if __name__ == '__main__': # main function
	...
	clusterno = [1800-100*i for i in range(2)] #+ [50, 30, 20, 10, 8] # [8] - M1 # range(18) 1915 - Preprocessed (Removed overlapping gen data in Clustering Algorithm i.e., retained only plants)
	...
	f.close()
	f = open('Test8Node.json','w') #open('200NodeData.json','w')
