...
public class DAMarket {
    ...
    public void dayAheadOperation(int h, int d, boolean FNCSActive) {
        //System.out.println("\n----------------------------------------------" +
        //                   "-----------------------");
        System.out.println("\nCollecting Bids and Offers at Hour " + h + " for DAM operation on day " + (d) );
        ...
        System.out.println("supplyOfferByGen: "+Arrays.deepToString(supplyOfferByGen)); */
        ...
        */
        ...
        for (int j = 0; j < numLSEAgents; j++) {
            ...
            loadProfile = lse.submitDAMLoadForecast(d, j, ames.getPsLse(), FNCSActive);
            ...
            demandBid = lse.submitDemandBid(d, j, ames.getPsLse(), FNCSActive);
        ...
        for (int j = 0; j < numNDGenAgents; j++) {
            ...
            NDGProfile = ndg.submitDAMNDGForecast(d, j, FNCSActive);
