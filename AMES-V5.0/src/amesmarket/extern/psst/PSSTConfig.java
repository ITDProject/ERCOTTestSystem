...
public class PSSTConfig {
	 ...
	 * @return
	 */
	public static PSSTConfig createDeterministicPSST(File referenceModel, File referenceFile, File python_Input, String solver) {
	...
	public Process createPSSTProcess() throws IOException{
		ProcessBuilder pb = new ProcessBuilder(this.getExecCmd());
                java.io.File scucres = new java.io.File("DataFiles/TempFiles");
		pb.directory(scucres);
