...
public class RTMarket {
    ...
    private final File scedOutFile = new File("DataFiles/RTMResults.dat");
    private final File rtRefModelFile = new File("DataFiles/RTMReferenceModel.dat");// new File("SCUCresources/ScenarioData/RTRefernceModel.dat");
    private final File unitCommitmentFile = new File("DataFiles/RTUnitCommitments.dat");
    ...
    public void evaluateRealTimeBidsOffers(
        ...
        hasSolution = sced.RTMSolutionCheck();
        //power
        rtDispatches = sced.getRTMDispatchSolution();
        rtBranchFlow = sced.getRTMBranchFlowSolution();
        //costs
