...
public class PowerGridConfigure5 extends javax.swing.JFrame {
    ...
    public PowerGridConfigure5(AMESFrame frame) {
       ...
       setTitle("Step 5: Input LSE parameters");
        ...
        dataModel = new DefaultTableModel(blankPriceSensitiveData,  priceSensitiveNames);
        // Create the table
...
public String DataVerify(){
    ...
    for (int k=0; k<lsePriceSensitiveDemandList.size(); k++) {
        ...
        for(int h=0; h<24; h++){
            double c=Double.parseDouble(tempPrice[h][4].toString());
            double d=Double.parseDouble(tempPrice[h][5].toString());
            double slMax=Double.parseDouble(tempPrice[h][6].toString());
        ...
        if(name.equalsIgnoreCase(temp[0].toString())){
            ...
            for (int j=0; j<lsePriceSensitiveDemandList.size(); j++) {
                ...
                if(name.equalsIgnoreCase(tempPrice[0][0].toString())){
                    ...
                    DefaultTableModel loadDataModel = new DefaultTableModel(priceDemand, priceSensitiveNames);
                    ...
                    for (int k=0; k<priceSensitiveNames.length; k++) {
