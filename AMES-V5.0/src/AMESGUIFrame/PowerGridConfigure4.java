...
//GEN-BEGIN:initComponents
    ...
    public String DataVerify() {
        ...
        for (int i = 0; i < verifyData.length; i++) {
            ...
            if (Double.parseDouble(verifyData[i][3].toString()) < 0.0) {
                strMessage += "The " + i + "th generator in SCost column is not bigger than 0.0\n";
            }
            ...
            if (Double.parseDouble(verifyData[i][8].toString()) < 0.0) {
                strMessage += "The " + i + "th generator in NS column is not bigger than 0.0\n";
            }
    ...
    Object[][] data = {
        {"Gen1", 1, 1, 1600, 14, 0.005, 0, 110, 2, 1000000},
        {"Gen2", 2, 1, 1200, 15, 0.006, 0, 100, 2, 1000000},
        {"Gen3", 3, 3, 8500, 25, 0.010, 0, 520, 2, 1000000},
        {"Gen4", 4, 4, 1000, 30, 0.012, 0, 200, 2, 1000000},
        {"Gen5", 5, 5, 5400, 10, 0.007, 0, 600, 2, 1000000}
    };
    final Object[] blankRowData = {"GenCo Name", 0, 0, 0, 0, 0, 0, 0, 0, 0};

    final Object[][] blankData = {{"GenCo Name", 0, 0, 0, 0, 0, 0, 0, 0, 0}};
