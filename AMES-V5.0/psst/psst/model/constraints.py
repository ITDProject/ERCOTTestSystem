...
def power_balance(m, b, t, StorageFlag=False, NDGFlag=False):
...
def net_power_at_bus_rule(m, b, t, StorageFlag=False, NDGFlag=False):
...
def constraint_net_power(model, StorageFlag=False, NDGFlag=False):
    partial_net_power_at_bus_rule = partial(net_power_at_bus_rule, StorageFlag=StorageFlag, NDGFlag=NDGFlag)
...
def constraint_power_balance(model, StorageFlag=False, NDGFlag=False):
    ...
    fn_power_balance = partial(power_balance, StorageFlag=StorageFlag, NDGFlag=NDGFlag)
